/* Fault handler information.  MacOSX version (all of PowerPC, i386 and arm).
...
#define SIGSEGV_FRAME_POINTER(thr_state)            (thr_state).__fp
...
#define SIGSEGV_THREAD_STATE_TYPE                   arm_thread_state_t
#define SIGSEGV_THREAD_STATE_FLAVOR                 ARM_THREAD_STATE
#define SIGSEGV_THREAD_STATE_COUNT                  ARM_THREAD_STATE_COUNT
#define SIGSEGV_EXC_STATE_TYPE                      arm_exception_state_t
#define SIGSEGV_EXC_STATE_FLAVOR                    ARM_EXCEPTION_STATE
#define SIGSEGV_EXC_STATE_COUNT                     ARM_EXCEPTION_STATE_COUNT

#define SIGSEGV_FAULT_ADDRESS(thr_state,exc_state)  (exc_state).__far
#define SIGSEGV_STACK_POINTER(thr_state)            (thr_state).__sp
#define SIGSEGV_PROGRAM_COUNTER(thr_state)          (thr_state).__pc
// #define SIGSEGV_FRAME_POINTER(thr_state)            (thr_state).__r[11]

#define SIGSEGV_INTEGER_ARGUMENT_1(thr_state)       (thr_state).__r[0]
#define SIGSEGV_INTEGER_ARGUMENT_2(thr_state)       (thr_state).__r[1]
#define SIGSEGV_INTEGER_ARGUMENT_3(thr_state)       (thr_state).__r[2]
